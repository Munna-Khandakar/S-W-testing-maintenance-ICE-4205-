                ...
                <ul class="nav navbar-nav navbar-right user-nav">
                    ...
                    <li class="dropdown avatar-dropdown">
                        ...
                        <ul class="dropdown-menu user-dropdown">
                            <li><a href="{{ route('seller_register') }}"><span class="fa fa-user-plus"></span>Seller Register </a></li>
                            <li><a href="{{ route('register') }}"><span class="fa fa-user-plus"></span>Admin Register </a></li>
        ...
        <div id="left-menu">
            <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="ripple">
                        <a href="{{route('restaurants')}}"><span class="fa icon-home"></span>Restaurants</a>
                    </li>
        ...
        <div class="mimin-mobile-menu-list">
            <div class="col-md-12 sub-mimin-mobile-menu-list animated fadeInLeft">
                <ul class="nav nav-list">
                    ...
                    <li class="ripple">
                        <a href="{{route('products')}}"><span class="fa fa-users"></span>Products</a>
                    </li>
                    <li class="ripple">
                         <a href="{{route('members')}}"><span class="fa fa-users"></span>Members</a>
                    </li>
                    <li class="ripple">
                         <a href="{{route('restaurants')}}"><span class="fa fa-users"></span>Restaurants</a>
                    </li>
